...
*/
	...
	$domain   = str_replace('.com', '', $url); // strip .com
...
*/
	...
	if($text) { //exclude empty string
	    ...
	    /* also check for domain w/o .com */
	    if( !is_int($key) && is_int(strpos('.com', $text)) ){
    	    	$key = $this->recursiveArraySearch($results, str_replace('.com', '', $text));
	    }
